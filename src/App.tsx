...
export default App;import PaymentStatusWrapper from './components/PaymentStatusWrapper';

function App() {
  return (
    <PaymentStatusWrapper>
      {/* ✅ Your actual app content - hanya visible jika user sudah paid */}
        ...
        <main className="max-w-7xl mx-auto px-4 py-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-gray-600 mb-6">
              This content is only visible to users who have completed payment.
            </p>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <h3 className="font-medium text-blue-900">Feature 1</h3>
                <p className="text-blue-700 text-sm mt-1">
                  Premium feature available to paid users
                </p>
              </div>
              
              <div className="bg-green-50 p-4 rounded-lg">
                <h3 className="font-medium text-green-900">Feature 2</h3>
              ...
              <div className="bg-purple-50 p-4 rounded-lg">
                <h3 className="font-medium text-purple-900">Feature 3</h3>
