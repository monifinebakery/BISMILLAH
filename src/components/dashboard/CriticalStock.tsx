...
const StockSummary: React.FC<{ items: StockItem[] }> = ({ items }) => {
  ...
  return (
    <div className="px-4 py-3 bg-gray-50 border-b border-gray-500">
...
const CriticalStock: React.FC<Props> = ({ items, isLoading }) => {
  ...
  return (
    <Card className="bg-white border">
      {/* ⚠️ Header */}
      <CardHeader className="bg-gradient-to-r from-red-50 to-orange-50 border-b border-gray-400 p-4">
