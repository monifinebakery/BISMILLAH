...
const QuickActionCard: React.FC<{
  ...
  return (
    <Card className="bg-white border border-gray-500 dark:border-gray-600 hover:border-orange-400 hover:shadow-md transition-all duration-300 overflow-hidden group">
      <Link 
        to={to} 
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="border border-orange-200 p-3 rounded-xl mr-4 group-hover:border-orange-300 group-hover:bg-orange-50 transition-all duration-300">
