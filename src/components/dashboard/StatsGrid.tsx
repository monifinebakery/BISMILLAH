...
const StatCard: React.FC<{
  ...
  const cardContent = (
    <Card className="bg-white border border-gray-500 dark:border-gray-700 relative group h-full">
      <CardContent className="card-stats h-full relative">
        {/* Inset Border Effect */}
        <div className="absolute inset-0 rounded-lg border border-orange-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
        
        {/* Content */}
        <div className="relative h-full flex flex-col">
          {/* 🎨 Icon dan Trend - Top row */}
          <div className="flex items-center justify-between mb-2 sm:mb-3">
            <div className="border border-orange-200 p-2.5 sm:p-3 rounded-xl flex-shrink-0 group-hover:border-orange-300 group-hover:bg-orange-50 transition-all duration-300 flex items-center justify-center">
        ...
        {/* Mobile Tooltip */}
        {tooltip && isMobile && (
          <div className="absolute inset-x-0 top-full mt-2 mx-4 p-3 bg-gray-900 text-white text-sm rounded-lg border border-gray-700 z-50 opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-200 pointer-events-none">
      ...
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent 
            side="top" 
            align="center"
            className="max-w-xs sm:max-w-sm md:max-w-md z-50 px-4 py-3 text-sm bg-gray-900 text-white rounded-lg border border-gray-700"
            sideOffset={8}
