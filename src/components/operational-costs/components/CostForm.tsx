          ...
          <div className="dialog-panel max-w-md w-full">
            ...
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                className="w-full text-left p-4 border border-green-200 rounded-lg hover:border-green-300 hover:bg-green-50 transition-colors"
              >
              ...
              <button
                ...
                className="w-full text-left p-4 border border-blue-200 rounded-lg hover:border-blue-300 hover:bg-blue-50 transition-colors"
              >
                <div className="flex items-start gap-3">
