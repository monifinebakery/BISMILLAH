            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-3">
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm">
                  <p className="font-medium text-green-900 mb-1">Klasifikasi Biaya Produksi</p>
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-green-700"><strong>Overhead Pabrik (HPP):</strong> Masuk ke perhitungan harga pokok produksi (termasuk TKL)</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <TrendingUp className="h-3 w-3 text-blue-600" />
                      <span className="text-green-700"><strong>Biaya Operasional:</strong> Didistribusikan per pcs, ikut HPP resep, dan dipakai untuk analisis BEP/pricing</span>
                    </div>
                  </div>
                  {!cost && (
