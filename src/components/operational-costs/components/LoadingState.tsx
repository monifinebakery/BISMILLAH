      ...
      {Array.from({ length: rows }).map((_, index) => (
        <div key={index} className="animate-pulse">
          <div className="bg-white p-6 rounded-lg border">
            ...
            <div className="h-8 bg-gray-500 rounded w-full mb-3"></div>
          ...
          <div key={index} className="animate-pulse p-4">
            <div className="grid grid-cols-5 gap-4 items-center">
              ...
              <div className="flex justify-end space-x-2">
                <div className="h-8 bg-gray-500 rounded w-8"></div>
                <div className="h-8 bg-gray-500 rounded w-8"></div>
              </div>
            </div>
          </div>
  ...
  const renderFormSkeleton = () => (
    <div className={`space-y-6 ${className}`}>
      <div className="animate-pulse">
        <div className="h-4 bg-gray-500 rounded w-1/4 mb-2"></div>
      ...
      <div className="flex justify-end space-x-3">
        <div className="animate-pulse h-10 bg-gray-500 rounded w-24"></div>
      </div>
    </div>
  );
