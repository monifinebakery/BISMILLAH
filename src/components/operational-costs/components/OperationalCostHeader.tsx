              ...
              return (
                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                  <div className="bg-white/10 border border-white/20 rounded-lg px-3 py-2.5">
                    ...
                    <div className="text-sm sm:text-base font-bold text-white">{activeCosts.length} biaya</div>
                  </div>
                  <div className="bg-white/10 border border-white/20 rounded-lg px-3 py-2.5">
                    <div className="text-xs uppercase tracking-wide text-white/75 mb-1">Total/bulan</div>
                    <div className="text-sm sm:text-base font-bold text-white">{formatCurrency(totalMonthly)}</div>
                  </div>
                  <div className="bg-white/10 border border-white/20 rounded-lg px-3 py-2.5">
                    <div className="text-xs uppercase tracking-wide text-white/75 mb-1">Biaya Produksi/pcs</div>
                    <div className="text-sm sm:text-base font-bold text-white">{formatCurrency(overheadPcs)}</div>
                  </div>
                  <div className="bg-white/10 border border-white/20 rounded-lg px-3 py-2.5">
                    <div className="text-xs uppercase tracking-wide text-white/75 mb-1">Operasional/pcs</div>
                    <div className="text-sm sm:text-base font-bold text-white">{formatCurrency(operasionalPcs)}</div>
                  </div>
                </div>
              );
            })()}
