...
export const METODE_ALOKASI_OPTIONS = [
  {
    ...
    example: 'Jika total biaya IDR 10.000.000 dan estimasi produksi 1.000 unit, maka overhead = IDR 10.000 per unit',
  ...
  },
  {
    ...
    example: 'Jika persentase 25% dan biaya material IDR 50.000, maka overhead = IDR 12.500',
