...
export interface OperationalCost {
  ...
  group: 'hpp' | 'operasional'; // Dual-mode cost group
  deskripsi?: string;
...
export interface CostFormData {
  ...
  jenis: 'tetap' | 'variabel';
  status: 'aktif' | 'nonaktif';
  group?: 'hpp' | 'operasional'; // Dual-mode cost group (optional for backward compatibility)
  deskripsi?: string;
...
export interface CostFilters {
  jenis?: 'tetap' | 'variabel';
  status?: 'aktif' | 'nonaktif';
  group?: 'hpp' | 'operasional'; // Filter by cost group
  search?: string;
}
