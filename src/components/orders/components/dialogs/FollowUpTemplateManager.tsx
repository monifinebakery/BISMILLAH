  ...
  const [templates, setTemplates] = useState<Template[]>([
    {
      ...
      message: 'Halo {nama_pelanggan}, terima kasih atas pesanan #{nomor_pesanan} senilai {total_pesanan}. Pesanan Anda sedang diproses.',
      createdAt: new Date()
    },
    {
      id: '2', 
      name: 'Update Pengiriman',
      message: 'Halo {nama_pelanggan}, pesanan #{nomor_pesanan} Anda sudah dikirim dan sedang dalam perjalanan. Terima kasih!',
      createdAt: new Date()
    },
    {
      id: '3',
