              ...
              <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      {order.items.map((item, index) => (
                        <div key={index} className="flex items-center justify-between py-2 border-b border-gray-400 last:border-0">
                ...
                <div className="border-t border-gray-500 pt-4">
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between text-base font-semibold text-gray-900 border-t border-gray-500 pt-2">
                      <span>Total</span>
