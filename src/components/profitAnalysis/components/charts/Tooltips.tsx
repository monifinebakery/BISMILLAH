...
export const CustomTooltip: React.FC<TooltipProps> = ({ active, payload, label, viewType }) => {
  ...
  return (
    <div className="bg-white p-4 border border-gray-500 rounded-xl shadow-xl backdrop-blur-sm">
...
export const CandlestickTooltip: React.FC<TooltipProps> = ({ active, payload, label }) => {
  ...
  return (
    <div className="bg-white p-4 border border-gray-500 rounded-lg shadow-lg">
