// PromoCalculatorLayout.jsx - Complete layout with lazy-loaded calculator and list
...
// 🎨 Loading fallback komponen
const LoadingFallback = ({ message = "Memuat..." }) => (
