      ...
      <CardContent className="space-y-6">
        ...
        {isSelectingExistingItem ? (
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              >
                <SelectTrigger className="h-11 border-gray-500 focus:border-orange-500 focus:ring-orange-500/20">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="h-11 w-full rounded-md border border-gray-500 px-3 py-2 text-sm focus:border-orange-500 focus:ring-orange-500/20"
              />
            </div>
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <SafeNumericInput
                ...
                placeholder="0"
                className="h-11 border-gray-500 focus:border-orange-500 focus:ring-orange-500/20"
              />
              <div className="flex items-center px-3 bg-gray-50 border border-gray-500 rounded-md text-sm text-gray-600 min-w-[70px] justify-center">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <SafeNumericInput
                ...
                className="h-11 pl-8 border-gray-500 focus:border-orange-500 focus:ring-orange-500/20"
                placeholder="0"
        ...
        <div className="space-y-2">
          ...
          <Textarea
            ...
            rows={2}
            className="border-gray-500 focus:border-orange-500 focus:ring-orange-500/20"
          />
        </div>
        ...
        <div className="space-y-2">
          {isSelectingExistingItem && existingIndex >= 0 ? (
            <Button
              ...
              disabled={!canSubmit}
              className="w-full h-11 bg-orange-500 hover:bg-orange-600 text-white border-0 disabled:bg-gray-500 disabled:text-gray-500"
            >
