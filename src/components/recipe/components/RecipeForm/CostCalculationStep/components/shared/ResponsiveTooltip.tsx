                ...
                <div className="w-80 max-w-[90vw] max-h-[85vh] sm:max-h-[80vh] overflow-y-auto">
                  ...
                  <div className="border-t border-gray-700 p-4">
                    <button
                      ...
                      className="w-full bg-gray-800 text-gray-500 py-3 px-4 rounded-lg text-sm font-medium hover:bg-gray-700 active:bg-gray-600 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900"
                    >
                      Tutup
                    </button>
                  </div>
