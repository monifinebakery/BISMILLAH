  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-white dark:bg-zinc-950 border-r-[1.5px] border-gray-300 dark:border-gray-700 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border-[1.5px] group-data-[variant=floating]:border-gray-300 group-data-[side=right]:border-r-0 group-data-[side=right]:border-l-[1.5px]"
        >
          {children}
        </div>
      </div>
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))] md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2 md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <Input ref={ref} data-sidebar="input" className={cn("h-8 w-full bg-background focus-visible:ring-2 focus-visible:ring-sidebar-ring", className)} {...props} />
))
...
const SidebarFooter = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="footer"
      className={cn("flex flex-col gap-2 p-2", state === "collapsed" && "items-center justify-center", className)}
      {...props}
    />
  )
})
