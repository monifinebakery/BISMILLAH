  ...
  return (
    ...
    >
      ...
      >
        <div
          data-sidebar="sidebar"
          className="flex h-full w-full flex-col bg-white dark:bg-zinc-950 border-r-[1.5px] border-gray-200 dark:border-gray-700 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border-[1.5px] group-data-[variant=floating]:border-gray-200 group-data-[side=right]:border-r-0 group-data-[side=right]:border-l-[1.5px]"
        >
          {children}
        </div>
      </div>
