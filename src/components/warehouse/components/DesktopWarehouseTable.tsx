          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-4">
                  {item.expiry ? (
                    <div className={`text-sm ${warehouseUtils.isExpiringItem(item) ? 'text-red-600 font-medium' : 'text-gray-900'}`}>
                ...
                <td className="px-4 py-4">
                  <div className="text-sm text-gray-500">
                    {warehouseUtils.formatLastUpdateCompact(item.updatedAt)}
                  </div>
                </td>
...
export default DesktopWarehouseTable;// src/components/warehouse/components/DesktopWarehouseTable.tsx
import React from 'react';
import { Button } from '@/components/ui/button';
import { 
  Edit2, 
