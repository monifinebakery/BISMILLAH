...
// 🎯 FIXED: Mobile Layout with Safe Bottom Area
...
const AddEditDialog: React.FC<AddEditDialogProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
      {/* 🎯 FIXED: Mobile responsive dialog with safe bottom area */}
      <div className="bg-white rounded-lg shadow-xl w-full max-w-5xl flex flex-col" 
           style={{ 
             height: 'calc(100vh - 160px)', // ✅ Reserve space for mobile bottom nav + safe area
             maxHeight: '90vh',
             minHeight: '500px'
           }}>
        ...
        {/* ✅ ADDED: Calculation info banner - Fixed */}
        ...
        {/* ✅ FIXED: Form content - Scrollable area */}
            ...
            <div className="flex-1 p-3 sm:p-6">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  {/* ✅ ENHANCED: Purchase Summary - Mobile optimized */}
                  {formData.jumlahBeliKemasan > 0 && formData.isiPerKemasan > 0 && formData.hargaTotalBeliKemasan > 0 && (
                  ...
                  {/* Stock Preview - Mobile optimized */}
                  ...
                  {/* ✅ ENHANCED: Calculation helper - Mobile optimized */}
        ...
        {/* ✅ FIXED: Footer - Always visible with safe bottom margin */}
        <div className="flex items-center justify-end gap-2 sm:gap-3 p-3 sm:p-6 border-t bg-gray-50 flex-shrink-0" 
