  ...
  return (
    <>
      ...
      <Toaster 
        ...
        toastOptions={{
          classNames: {
            toast: 'bg-white text-gray-900 border border-gray-500',
            title: 'text-gray-900 font-medium',
            description: 'text-gray-600',
            actionButton: 'bg-orange-500 text-white hover:bg-orange-600',
            cancelButton: 'bg-gray-400 text-gray-900 hover:bg-gray-500',
            closeButton: 'bg-gray-400 text-gray-400 hover:text-gray-600',
