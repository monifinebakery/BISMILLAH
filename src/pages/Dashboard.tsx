...
  if (!date || !(date instanceof Date) || isNaN(date.getTime())) { // Tambahkan isNaN(date.getTime())
...
const Dashboard = () => {
  // Menggunakan 'loading' state dari useActivity
...
            <CardContent className="p-6">
              <div className="space-y-4">
                {activitiesLoading ? ( // Menampilkan loading state
                  <p className="text-center text-muted-foreground py-4">Memuat aktivitas...</p>
                ) : activities.length > 0 ? (
