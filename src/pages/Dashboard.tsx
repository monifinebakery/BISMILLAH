...
const Dashboard = () => {
    ...
    // State untuk filter tanggal global, default: Hari Ini
    ...
    // Logika Inti yang Terhubung ke Filter Tanggal
    ...
    const profitInRange = useMemo(() => revenueInRange * 0.3, [revenueInRange]);
    ...
    // Helper functions & pagination logic
    const getGreeting = () => {
    ...
    // Komponen untuk Pilihan Cepat (Presets)
        ...
        return (
            <div className="flex flex-col space-y-1 p-2">
                {presets.map(({ label, range }) => (
                    <Button key={label} variant="ghost" className="w-full justify-start" onClick={() => setDateRange(range)}>
                        {label}
                    </Button>
                ))}
            </div>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-gray-800 text-lg">{formatCurrency(revenueInRange)}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-gray-800 text-lg">{ordersInRange}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-gray-800 text-lg">{formatCurrency(profitInRange)}</p>
                    ...
                    <CardContent className="p-4">
                        <div className="flex items-center">
                            ...
                            <div>
                                ...
                                <p className="font-semibold text-orange-600 text-lg">{outstandingInvoices}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <Card className="bg-white border border-gray-100 shadow-sm">
                        ...
                        {bestSellingProducts.length > itemsPerPage && (
                             <CardFooter className="flex items-center justify-between py-3 border-t border-gray-100">
                                <Button variant="outline" size="sm" onClick={() => setProductsPage(p => p - 1)} disabled={productsPage === 1}><ChevronLeft className="h-4 w-4" /></Button>
                                <span className="text-sm text-gray-500">Halaman {productsPage} dari {totalProductsPages}</span>
                                <Button variant="outline" size="sm" onClick={() => setProductsPage(p => p + 1)} disabled={productsPage >= totalProductsPages}><ChevronRight className="h-4 w-4" /></Button>
                            </CardFooter>
                        )}
                    </Card>
                ...
                <div className="space-y-6">
                    <Card className="bg-white border border-gray-100 shadow-sm">
                        ...
                        <CardContent className="p-0">
                            <Table>
                                <TableHeader>
                                    <TableRow><TableHead>Aktivitas</TableHead><TableHead>Waktu</TableHead><TableHead className="text-right">Jumlah</TableHead></TableRow>
                                </TableHeader>
                                <TableBody>
                        ...
                        {filteredActivities.length > itemsPerPage && (
                            <CardFooter className="flex items-center justify-between py-3 border-t border-gray-100">
                                <Button variant="outline" size="sm" onClick={() => setActivitiesPage(p => p - 1)} disabled={activitiesPage === 1}><ChevronLeft className="h-4 w-4" /></Button>
                                <span className="text-sm text-gray-500">Halaman {activitiesPage} dari {totalActivitiesPages}</span>
                                <Button variant="outline" size="sm" onClick={() => setActivitiesPage(p => p + 1)} disabled={activitiesPage >= totalActivitiesPages}><ChevronRight className="h-4 w-4" /></Button>
                            </CardFooter>
                        )}
                    </Card>
