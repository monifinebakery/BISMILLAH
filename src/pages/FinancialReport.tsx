...
import { AreaChart, Area, BarChart, Bar, XAxis, YAxis, CartesianGrid, ComposedChart, Line, ResponsiveContainer } from 'recharts'; // Tambahkan ComposedChart, Line, ResponsiveContainer
