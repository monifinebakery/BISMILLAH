          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={transactionData} margin={{ top: 5, right: 20, left: 10, bottom: 5 }}>
                {/* Membungkus children LineChart dengan React.Fragment secara eksplisit */}
                <React.Fragment> {/* Pastikan ini dan tag penutupnya ada */}
                  ...
                  />
                </React.Fragment> {/* Pastikan ini ada */}
              </LineChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  {/* Membungkus children PieChart dengan React.Fragment secara eksplisit */}
                  <React.Fragment> {/* Pastikan ini dan tag penutupnya ada */}
                    <Pie
                      dataKey="value"
