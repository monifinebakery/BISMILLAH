...
import HPPCalculatorComponent from "@/components/HPPCalculator";
import ResultDisplay from "@/components/ResultDisplay";
import { useState } from "react";
import { HPPData } from "@/types/hpp";

const QuickCalculatorPage = () => {
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4">
            ...
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 mt-1">
                Hitung HPP dan harga jual dengan input manual sederhana
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-8">
          ...
          <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
            ...
            <CardContent className="p-4 sm:p-6">
              <HPPCalculatorComponent hppData={hppData} setHppData={setHppData} isQuickMode={true} />
            </CardContent>
          </Card>
