    ...
    <div className="w-full p-4 sm:p-6">
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <div className="h-8 w-64 bg-gray-500 rounded animate-pulse mb-2"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[1,2,3,4].map(i => (
            <div key={i} className="bg-white rounded-lg border p-6">
              <div className="h-4 w-24 bg-gray-500 rounded animate-pulse mb-2"></div>
              <div className="h-8 w-16 bg-gray-500 rounded animate-pulse"></div>
            </div>
          ))}
        </div>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="w-full p-4 sm:p-6 space-y-6">
        ...
        {/* ✅ Main Content Card */}
        <Card className="border border-gray-500 bg-white/90 backdrop-blur-sm">
