...
import BahanBakuEditDialog from '@/components/BahanBakuEditDialog'; // Asumsi komponen ini masih dipakai
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-red-50 p-4 sm:p-8">
      ...
      {lowStockItems.length > 0 && (
        <Card className="mb-6 bg-red-50 border-red-200">
          <CardHeader><CardTitle className="flex items-center text-red-700"><AlertTriangle className="h-5 w-5 mr-2" />Peringatan Stok Rendah</CardTitle></CardHeader>
            ...
            <Table>
              ...
              <TableBody>
                {isLoading ? (
                  ...
                  <TableRow key={item.id} className={item.stok <= item.minimum ? 'bg-red-50/50' : ''}>
