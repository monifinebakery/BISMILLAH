  ...
  return {
    ...
    server: {
      ...
      headers: {
        ...
        'Content-Security-Policy': [
          "default-src 'self'",
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://kewhzkfvswbimmwtpymw.supabase.co",
          "style-src 'self' 'unsafe-inline' data:",
          "img-src 'self' data: https: blob:",
          "font-src 'self' data:",
          "connect-src 'self' https://kewhzkfvswbimmwtpymw.supabase.co wss://kewhzkfvswbimmwtpymw.supabase.co https://api.github.com",
          "frame-src 'self'",
