  ...
  return {
    ...
    server: {
      ...
      headers: {
        ...
        'Content-Security-Policy': [
          "default-src 'self'",
          "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://kewhzkfvswbimmwtpymw.supabase.co https://challenges.cloudflare.com https://*.cloudflare.com",
          "style-src 'self' 'unsafe-inline' https://challenges.cloudflare.com https://*.cloudflare.com data:",
          "img-src 'self' data: https: blob:",
          "font-src 'self' data:",
          "connect-src 'self' https://kewhzkfvswbimmwtpymw.supabase.co wss://kewhzkfvswbimmwtpymw.supabase.co https://challenges.cloudflare.com https://*.cloudflare.com",
